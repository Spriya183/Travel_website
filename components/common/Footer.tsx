...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-luxury-dark via-luxury-dark to-black text-zinc-300 pt-20 pb-8 z-20 overflow-hidden">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 z-50 bg-gradient-to-br from-gold to-gold-light hover:from-gold-light hover:to-gold text-white p-4 rounded-2xl shadow-2xl transition-all duration-500 hover:-translate-y-1 hover:shadow-gold/30 ${isVisible ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 translate-y-10 pointer-events-none"
          }`}
