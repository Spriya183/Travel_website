...
export default function CTA() {
  return (
    <section
      className="relative py-28 bg-cover bg-center bg-no-repeat bg-fixed z-20 text-white overflow-hidden"
      style={{ backgroundImage: `url('/images/hero_mountains.png')` }}
    >
      {/* Dark overlay with luxury gradient */}
      <div className="absolute inset-0 bg-gradient-to-r from-luxury-dark/95 via-primary/90 to-luxury-dark/95 z-10" />
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-20">
        ...
        <p className="font-sans text-base sm:text-lg md:text-xl text-zinc-200 max-w-2xl mx-auto leading-relaxed mb-10">
          Travel comfortably, safely, and reliably with Clasic Journey Nepal. Book your luxury airport taxi, hotel transfer, or customized sightseeing tour today.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          >
            <CalendarDays className="group-hover:rotate-12 transition-transform duration-300" size={20} />
