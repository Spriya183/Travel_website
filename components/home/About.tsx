        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-gold/20"
            >
              <div className="flex flex-col text-center sm:text-left">
                <CountUp target={2} suffix="+" />
                <span className="font-sans text-xs font-semibold text-zinc-500 uppercase tracking-wider">
                  Tourist Taxis
                </span>
              </div>
              <div className="flex flex-col text-center sm:text-left">
